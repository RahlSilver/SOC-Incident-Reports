...
Actions Taken
1.	The activity was reviewed in the context of normal internal behavior. No prior pattern of administrative access attempts from these IPs was observed.
2.	Searched for additional failed login attempts before and after the reported timestamps.
3.	Marked source IPs for continued monitoring.
4.	Notified system owner / IT operations team for validation of internal IP activity.
